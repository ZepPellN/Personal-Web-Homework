...
// var multiracelist = [];
var racelist = [];
var curP_race = 0, allpages_race = 0;
...
function writeRace(pno,type) {
    ...
    for (i = pno * recordNum; i < (pno + 1) * recordNum && i < numOfRace; i++) {
        // if(type === "single"){
        //     temp = singleracelist[i];
        // }else if(type === "multi"){
        //     temp = multiracelist[i];
        // }
        temp = racelist[i];
        ...
        if(type === "single"){
            ...
            title_link.attr("href","../../template/race/RaceInformation.php?title=" + title + "&&join="+temp.sign);
