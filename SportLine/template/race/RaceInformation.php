...
<!--                            </div>-->
<!--                        </div>-->
<!--                        <button class="btn btn-default pull-right" type="submit">Join</button>-->
                    </div>
                    <h4 style="position:relative; padding-top:8%">Racing Details:</h4>
                    <br/>
...
<script src="../../js/raceInformation.js"></script>
<script>
