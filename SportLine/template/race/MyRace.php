            ...
            <div class="card">
                ...
                <div class="row">
                    <ul class="nav navbar-nav navbar-right">
                        <li style="position:relative;margin-left:48%"><a href="javascript:gotopage_Race('-1','single');"> <i
                                    class="ti-angle-left"></i>
                            </a></li>
                        <li id="pages" style="position:relative;margin-left:50%; margin-top:-2.3%">0/0</li>
                        <li style="position:relative;margin-left:52.5%;margin-top:-2.05%"><a href="javascript:gotopage_Race('1','single');"> <i
...
<script src="../../js/myrace.js"></script>
<script>
    var type = "";
    var state = "";
    var own = "";
